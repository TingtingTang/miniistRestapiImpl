...
(function() {
    ...
    angular
        .module('angle', [
            ...
            'app.translate',
            'app.settings',
            'app.elements',		//custom add-on (FXX, 2016Apr7)
            'app.utils',
            'app.notify',		//custom add-on (FXX, 2016Apr7)
        ]);
})();

/* =============================@ mini IST user defined ============================ */
...
/* =========================================================
 * 			- - mini-IST add-on - -
 * (from master/js/modules/xxx/xxx.module.js)
 * =========================================================*/
(function() {
    'use strict';
...
(function() {
    ...
    function routesConfig($stateProvider, $locationProvider, $urlRouterProvider, helper){
        ...
        $stateProvider
          ...
          .state('app.dashboard', {
              url: '/dashboard',
              title: 'Mini IST Dashboard (Landscape)',
          ...
          .state('app.vdefstarun', {
              url: '/vdefstarun',
              title: 'Mini IST View/Define/StartRun',
              templateUrl: helper.basepath('vdefstarun.html')
          })
          .state('app.manager', {
              url: '/manager',
...
(function() {
    ...
    function settingsRun($rootScope, $localStorage){
      ...
      $rootScope.app = {
        ...
        name: 'z/OS SVT',
        description: 'miniIST Web Application',
...
(function() {
    ...
    function translateConfig($translateProvider){
      ...
      $translateProvider.useStaticFilesLoader({
          //prefix : 'app/i18n/',
          prefix : 'i18n/',		//**changed for node.js, by FXX 2016Mar31
          suffix : '.json'
      });
...
/* =========================================================
 * 			- - mini-IST add-on - -
 * >>from master/js/modules/xxx/xxx.controller.js
 * >>from master/js/modules/xxx/xxx.directive.js
 * >>from master/js/modules/xxx/xxx.service.js
 * =========================================================*/
