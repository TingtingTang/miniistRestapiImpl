...
(function() {
    ...
    function ChartJSController(Colors) {
        ...
        function activate() {
          ...
          var rFactor = function(){ return Math.round(Math.random()*50); };
...
(function() {
    ...
    function paneltool ($compile, $timeout) {
        ...
        function link(scope, element, attrs) {
          ...
          /* -- customed for mini-ist (FXX, 2016May6) 
          var templates = {
          ...
          var templates = {
            collapse:'<a href="#" panel-collapse="" uib-tooltip="Collapse" ng-click="{{panelId}} = !{{panelId}}"> \
                        <em ng-show="{{panelId}}" class="fa fa-plus ng-no-animation"></em> \
                        <em ng-show="!{{panelId}}" class="fa fa-minus ng-no-animation"></em> \
                      </a>',
            dismiss: '<a href="#" panel-dismiss="" uib-tooltip="Close">\
                       <em class="fa fa-times"></em>\
                     </a>',
            refresh: '<a href="#" panel-refresh="" data-spinner="{{spinner}}" uib-tooltip="Refresh">\
                       <em class="fa fa-refresh"></em>\
                     </a>'
          };
    ...
    function routesConfig($stateProvider, $locationProvider, $urlRouterProvider, helper){
        ...
        $stateProvider
          .state('app', {
              ...
              //resolve for lazyload??
              resolve: helper.resolveFor(
              	'fastclick', 'modernizr', 'icons', 'screenfull', 'animo', 
              	'sparklines', 'slimscroll', 'classyloader', 'toaster', 'whirl',
              	'xeditable', 'ngTable', 'oitozero.ngSweetAlert', 'angular-carousel','chartjs'
              )
          })
          .state('app.welcome', {
              url: '/welcome',
          ...
          .state('app.userprofile', {
              url: '/userprofile',
              title: 'Mini IST User Profile',
              templateUrl: helper.basepath('userprofile.html')
          })
          .state('app.useraccount', {
              url: '/useraccount',
              title: 'Mini IST User Account',
              templateUrl: helper.basepath('useraccount.html')
          })
          .state('app.dashboard', {
              url: '/dashboard',
              title: '控制台',
          ...
          .state('app.dashv1', {
              url: '/dashv1',
              title: 'Mini IST Dashboard v1',
              templateUrl: helper.basepath('dashv1.html')
          })
          .state('app.dashv2', {
              url: '/dashv2',
              title: 'Mini IST Dashboard v2',
              templateUrl: helper.basepath('dashv2.html')
          })
          .state('app.machinelist', {
              url: '/machinelist',
              title: 'Mini IST Machine List',
              templateUrl: helper.basepath('machinelist.html')
          })
          .state('app.testsuite', {
              url: '/testsuite',
              title: 'Mini IST Testcase Suite',
              templateUrl: helper.basepath('testsuite.html')
          })
          .state('app.manager', {
              url: '/manager',
              title: 'Mini IST Manager',
              templateUrl: helper.basepath('manager.html')
          })
          .state('app.workload', {
              url: '/workload',
              title: 'Mini IST Workload',
              templateUrl: helper.basepath('workload.html'),
...
(function() {
    ...
    UserBlockController.$inject = ['$rootScope', '$scope', 'localStorageService'];
    function UserBlockController($rootScope, $scope, localStorageService) {
        ...
        function activate() {
          ...
          $rootScope.user.name = localStorageService.get("username");
...
(function() {
    ...
    function settingsRun($rootScope, $localStorage){
      ...
      $rootScope.app = {
        name: 'mini IST',
        description: 'mini IST Web Application',
